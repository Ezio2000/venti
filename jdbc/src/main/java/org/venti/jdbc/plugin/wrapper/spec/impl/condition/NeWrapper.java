...
import org.venti.jdbc.plugin.wrapper.spec.func.condition.NeFunc;
...
public class NeWrapper implements Wrapper, NeFunc {
    ...
    @Override
    public NeWrapper ne(String column, Consumer<SelectSqlFunc> consumer) {
